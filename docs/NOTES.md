...
Working notes for this repository: current state of each script, and the things worth knowing before touching the code.
...
Reference library: Zotero ▸ Sociophysics ▸ IsingCR (18 items), kept locally as
Markdown conversions (not redistributed). 16 are actually cited in the manuscript; 2 (Godoy-Lorite & Jones 2020,
